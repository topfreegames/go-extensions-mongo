...
func (m *Mongo) Run(cmd interface{}, result interface{}) error {
	...
	operationName, tags := buildTracingParams(database, database, "runCommand", args)

	tracing.Trace(m.ctx, operationName, tags, func() {
		m.db.With(session).Run(cmd, result)
	})
...
func (c *Collection) Insert(docs ...interface{}) error {
	...
	operationName, tags := buildTracingParams(database, collection, "insert", args)

	tracing.Trace(c.ctx, operationName, tags, func() {
		c.collection.Insert(docs...)
	})
...
func (c *Collection) UpsertId(id interface{}, update interface{}) (*mgo.ChangeInfo, error) {
	...
	operationName, tags := buildTracingParams(database, collection, "updateOne", args)
...
func (c *Collection) RemoveId(id interface{}) error {
	...
	operationName, tags := buildTracingParams(database, collection, "remove", args)
...
func (b *Bulk) Run() (*mgo.BulkResult, error) {
	...
	operationName, tags := buildTracingParams(database, collection, "bulkRun", args)

	tracing.Trace(b.ctx, operationName, tags, func() {
...
func (q *Query) All(result interface{}) error {
	...
	operationName, tags := buildTracingParams(q.database, q.prefix, "find", q.args)

	tracing.Trace(q.ctx, operationName, tags, func() {
...
func (q *Query) One(result interface{}) error {
	...
	operationName, tags := buildTracingParams(q.database, q.prefix, "findOne", q.args)
...
func (p *Pipe) All(result interface{}) error {
	...
	operationName, tags := buildTracingParams(p.database, p.prefix, "aggregate", p.args)

	tracing.Trace(p.ctx, operationName, tags, func() {
...
func buildTracingParams(databaseName, prefix, method, args string) (string, opentracing.Tags) {
